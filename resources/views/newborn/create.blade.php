...
@section('title', 'Create Newborn Database Application')
...
<form method="POST" action="{{ route('newborn.store') }}">
    ...
    <div class="container">
        <div class="mb-3">
            ...
            @enderror
            <input type="text" class="form-control" name="mothers_name" id="mothers_name" placeholder="Full Name">
        </div>
        <div class="mb-3">
        ...
        <label for="infant_gender" class="form-label">Infant Gender</label>
            @error('infant_gender')
            <p class="error-message">{{ $message }}</p>
            @enderror
            <input class="form-control" list="infant_gender" name="infant_gender" placeholder="Type to search...">
        ...
        <div class="mb-3">
            ...
            <p class="error-message">{{ $message }}</p>
            @enderror
            <input type="text" class="form-control" id="infant_birtdate" name="infant_birtdate" placeholder="day mounth years">
        </div>
        <div class="mb-3">
            ...
            <p class="error-message">{{ $message }}</p>
            @enderror
            <input type="number" class="form-control" id="gestational_age" name="gestational_age" placeholder="">
        </div>
        <div class="mb-3">
            ...
            <p class="error-message">{{ $message }}</p>
            @enderror
            <input type="number" name="height" class="form-control" id="height" placeholder="">
        </div>
        <div class="mb-3">
